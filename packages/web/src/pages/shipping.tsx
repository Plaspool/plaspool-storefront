      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-12">
            {/* Shipping Coverage */}
            <Card className="border-0 shadow-lg bg-gray-600">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                    <span className="text-blue-900 font-bold font-mono">1</span>
                  </div>
                  <div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-200">Within Nigeria</h4>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-200">Africa & Worldwide</h4>
                        <p className="text-sm text-slate-300 font-mono">
            ...
            <Card className="border-0 shadow-lg bg-gray-600">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                    <span className="text-blue-900 font-bold font-mono">2</span>
                  </div>
                  <div>
              ...
              <CardContent className="space-y-4">
                <ul className="space-y-3 text-gray-200 font-mono text-sm">
            ...
            <Card className="border-0 shadow-lg bg-gray-600">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                    <span className="text-blue-900 font-bold font-mono">3</span>
                  </div>
                  <div>
                ...
                <div className="rounded-lg p-4 space-y-3">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <h4 className="font-semibold text-gray-100">Domestic Delivery</h4>
                      <p className="text-sm text-gray-100 font-mono">2–5 business days</p>
                    </div>
                    <div className="space-y-2">
                      <h4 className="font-semibold text-gray-100">International Delivery</h4>
            ...
            <Card className="border-0 shadow-lg bg-gray-600">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                    <span className="text-blue-900 font-bold font-mono">4</span>
                  </div>
                  <div>
            ...
            <Card className="border-0 shadow-lg bg-gray-600">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-yellow-100 rounded-lg flex items-center justify-center">
                    <span className="text-yellow-700 font-bold font-mono">5</span>
                  </div>
                  <div>
              ...
              <CardContent className="space-y-4">
                <ul className="space-y-3 font-mono text-sm">
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-yellow-600 rounded-full mt-2 text-gray-200"></div>
              ...
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center">
                    <span className="text-red-700 font-bold font-mono">6</span>
                  </div>
                  <div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Returns & Refunds</h2>
            <p className="text-lg text-slate-600">Simple, straightforward return process</p>
          </div>
          ...
          <div className="space-y-8">
              ...
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center">
                    <span className="text-green-700 font-bold font-mono">7</span>
                  </div>
                  <div>
            ...
            <Card className="border-0 shadow-lg bg-gray-600">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                    <span className="text-blue-900 font-bold font-mono">8</span>
                  </div>
                  <div>
              ...
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center">
                    <span className="text-purple-700 font-bold font-mono">9</span>
                  </div>
                  <div>
              ...
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center">
                    <span className="text-orange-700 font-bold font-mono">10</span>
                  </div>
                  <div>
